...
public class BPMLL extends MultiLabelLearnerBase {
    ...
    public static final double NET_BIAS = 1;
    protected static final double ERROR_SMALL_CHANGE = 0.000001;
    ...
    protected double weightsDecayCost = 0.00001;
    protected double learningRate = 0.05;
    private int[] hiddenLayersTopology;
    // members related to normalization or attributes
    protected boolean normalizeAttributes = true;
    protected NormalizationFilter normalizer;
    protected NeuralNet model;
    protected ThresholdFunction thresholdF;
    ...
    protected ThresholdFunction buildThresholdFunction(List<DataPair> trainData) {
    ...
    protected NeuralNet buildNeuralNetwork(int inputsDim) {
     ...
     */
    protected List<DataPair> prepareData(MultiLabelInstances mlData) {
